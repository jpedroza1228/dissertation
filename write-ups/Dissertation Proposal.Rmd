...
preliminary_ltpa_long <- lmer(ltpa_percent ~ year + (1 | state_fips_code) + (1 | state_fips_code:county_fips_code), 
                       data = county,
                       REML = FALSE,
...
VarCorr(preliminary_ltpa_long)
ltpa_null_icc <- as.tibble(VarCorr(preliminary_ltpa_long))
ltpa_null_icc
...
performance::icc(preliminary_ltpa_long)
