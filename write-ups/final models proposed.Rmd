...
```{r preliminary physical activity, eval = FALSE}
names(county)
...
preliminary_ltpa_long_3 <- lmer(ltpa_percent ~ year + (1|state_fips_code/county_fips_code), 
                       data = county,
                       REML = FALSE,
                    control = lmerControl(optimizer = 'Nelder_Mead'))
...
summary(preliminary_ltpa_long_3)
...
```{r preliminary access, eval = FALSE}
...
preliminary_access_pa_long_3 <- lmer(access_pa ~ year + (1|state_fips_code/county_fips_code), 
                       data = county,
                       REML = FALSE,
                    control = lmerControl(optimizer = 'Nelder_Mead'))
...
summary(preliminary_access_pa_long_3)
...
```{r access longitudinal with controls, eval = FALSE}
names(county)
...
ltpa_long_controls_3 <- lmer(ltpa_percent ~ year + violent_crime +
                                  adult_obesity + some_college +
                                  income_inequality + air_pollution_particulate_matter +
                                  driving_alone_to_work + percent_rural +
...
summary(ltpa_long_controls_3)

anova(ltpa_long_controls, ltpa_long_controls_3)
...
```{r physical activity included, eval = FALSE}
...
ltpa_long_access_3 <- lmer(ltpa_percent ~ year + violent_crime +
                                  adult_obesity + some_college +
                                  income_inequality + air_pollution_particulate_matter +
                                  driving_alone_to_work + percent_rural + 
                                  access_pa + (1|state_fips_code/county_fips_code), 
                       data = county,
                       REML = FALSE,
                    control = lmerControl(optimizer = 'Nelder_Mead'))

summary(ltpa_long_access_3)

anova(ltpa_long_access, ltpa_long_access_3)
...
access_latino_int_3 <- lmer(ltpa_percent ~ year + violent_crime +
                                  adult_obesity + some_college +
                                  income_inequality + air_pollution_particulate_matter +
                                  driving_alone_to_work + percent_rural + 
                                  access_pa*percent_hispanic + (1|state_fips_code/county_fips_code), 
                       data = county,
                       REML = FALSE,
                    control = lmerControl(optimizer = 'Nelder_Mead'))

summary(access_latino_int_3)

anova(access_latino_int, access_latino_int_3)
